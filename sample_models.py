...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    bidir_1 = Bidirectional(GRU(units,return_sequences=True,dropout=0.25))(bn_cnn)
    bn_1 = BatchNormalization()(bidir_1)
    
    bidir_2 = Bidirectional(GRU(units,return_sequences=True,dropout=0.25))(bn_1)
    bn_2 = BatchNormalization()(bidir_2)
    
    time_dense = TimeDistributed(Dense(output_dim))(bn_2)
